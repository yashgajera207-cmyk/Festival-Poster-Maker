...
export default function CreateTemplateContent() {
    ...
    <div className="min-h-screen bg-gray-100 px-6 py-8 pb-16">
      ...
      <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-[1fr_280px] gap-5 items-start">
              ...
              {!backgroundImage ? (
                ...
                <>
                  ...
                  <div className="mt-2.5">
                    <LogoUpload
                      onUploadSuccess={(url: string) => setBackgroundImage(url)}
                    />
                  </div>
                </>
              )}
        ...
        <div className="flex flex-col gap-4">
          <div className="bg-white border border-gray-200 rounded-2xl shadow-sm p-5">
            ...
            <div className="mt-4 space-y-3">
              {steps.map((step) => (
                ...
                >
                  <div
                    className={`w-7 h-7 rounded-full flex items-center justify-center text-xs font-semibold ${step.done ? "bg-orange-500 text-white" : "bg-gray-100 text-gray-400"}`}
                  >
                    {step.done ? <CheckCircle2 size={14} /> : step.num}
                  </div>
                  <span
                    className={step.done ? "text-gray-700" : "text-gray-400"}
                  >
                    {step.label}
                  </span>
                </div>
          ...
          <div className="bg-orange-50 border border-orange-200 rounded-2xl p-5 text-sm text-gray-600">
            <p className="font-semibold text-orange-600 mb-1">Tips</p>
            <ul className="space-y-2 text-xs text-gray-500">
              <li>
                • Use a clean, high-contrast background for better festival
                visibility.
              </li>
              <li>• Choose a category that matches the event style.</li>
              <li>• Preview your image before publishing.</li>
            </ul>
          </div>
        </div>
      </div>
